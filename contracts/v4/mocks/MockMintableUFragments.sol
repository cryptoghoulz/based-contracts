 ...
 */
contract MockMintableUFragments is ERC20Detailed, Ownable {
    ...
    constructor () public {
        deployer = msg.sender;
        initialize("MockMintableUFragments", "MMUF", msg.sender);
    }
    /**
        ...
        initializer
    {
        ...
        emit Transfer(address(0x0), owner_, balanceOf(owner_));
    }
